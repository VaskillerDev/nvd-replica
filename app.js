...
const port = 3000;
const key = fs.existsSync(process.env.PATH_TO_KEY) && fs.readFileSync(process.env.PATH_TO_KEY);
const cert = fs.existsSync(process.env.PATH_TO_CERT) && fs.readFileSync(process.env.PATH_TO_CERT);
